...
function sendEmail(params){
  console.log("hjgyftdcgvhjyftd");
  var tempParams = {
      from_name: document.getElementById("namejs").value,
      email_sender: document.getElementById("emailjs").value,
      subject_sender: document.getElementById("subjectjs").value,
      message_sender: document.getElementById("descriptionjs").value,
  };
  emailjs.send('service_21yrwfe','template_fqlj41e',tempParams)
   .then(function(res){
      Swal.fire({
          position: 'center',
          icon: 'success',
...
document.getElementById("skills").addEventListener("click", function(event) {
  var slider = document.getElementById("extrainformation");
